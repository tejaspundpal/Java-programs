...
public class Exp12_MouseEventExample extends JFrame implements MouseListener, MouseMotionListener {
    JLabel label = new JLabel("None");

    public Exp12_MouseEventExample() {
    ...
    public static void main(String[] args) {
        Exp12_MouseEventExample Exp12_MouseEventExample = new Exp12_MouseEventExample();
    }
