...
public class Exp13_Notepad extends JFrame implements ActionListener, TextListener, DocumentListener {
    public static Exp13_Notepad frame;
    public JTextArea textArea;
    public boolean isSaved;
    public String fileName = "";
    public File file = null;

    public Exp13_Notepad() {
